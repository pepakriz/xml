...
<schema xmlns="http://www.ascc.net/xml/schematron">
  ...
  <pattern name="Element SHOPITEM musí obsahovat všechny následující elementy">
    <rule context="/SHOP/SHOPITEM">   
      ...
      <report test="count(IMGURL) &gt; 1">element SHOPITEM musí obsahovat nejvýše jednu položku IMGURL</report>
      <report test="count(PRICE) != 1">element SHOPITEM musí obsahovat právě jednu položku PRICE</report>
      <report test="count(TYPE) &gt; 1">element SHOPITEM musí obsahovat nejvýše jednu položku TYPE</report>
      <report test="count(SIZE) &gt; 1">element SHOPITEM musí obsahovat nejvýše jednu položku SIZE</report>
      <report test="count(TAG) &gt; 1">element SHOPITEM musí obsahovat nejvýše jednu položku TAG</report>
      <report test="count(FUNCTION_TYPE) &gt; 1">element SHOPITEM musí obsahovat právě jednu položku FUNCTION_TYPE</report>
      <report test="count(OUTPUT_TYPE) &gt; 1">element SHOPITEM musí obsahovat právě jednu položku OUTPUT_TYPE</report>
      <report test="count(DIMENSIONS_TYPE) &gt; 1">element SHOPITEM musí obsahovat právě jednu položku DIMENSIONS_TYPE</report>
      <report test="count(CATEGORY_TYPE) &gt; 1">element SHOPITEM musí obsahovat právě jednu položku CATEGORY_TYPE</report>
 ...
 <!-- SIZE elementy -->
  <pattern name="Element SIZE musí obsahovat všechny následující elementy">
